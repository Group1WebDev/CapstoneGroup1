    ...
    <section className='profilePage'>
      ...
      <div className='personal_details'>
        ...
        <div className='profile_input'>
          <label>Bio</label>
          {isUserEditing ? <textarea className={changeClass} cols='30' rows='6' value={companyInfo} onChange={(e) => setCompanyInfo(e.target.value)} /> : <textarea cols='30' rows='6' value={companyInfo} disabled></textarea>}
        </div>
