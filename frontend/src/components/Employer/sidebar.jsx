    ...
    <div className={`dashboard_sidebar ${sidebarCollapse ? 'collapsed_sidebar' : ''}`}>
      <ul>
        <li className='sidebar_logo'>
          <NavLink>
            <h2>Talenthunt</h2>
            <div className='sidebar_icon' onClick={sidebarHandler}>
        ...
        <li>
          <NavLink exact activeclassname='is-active' to='/employer/JobsPosted'>
            <div className='sidebar_icon'>
        ...
        <li>
          <NavLink exact activeclassname='is-active' to='/employer/addJob'>
            <div className='sidebar_icon'>
        ...
        <li>
          <NavLink exact activeclassname='is-active' to='/emplpoyer/candidatesList'>
            <div className='sidebar_icon'>
        ...
        <li>
          <NavLink exact activeclassname='is-active' to='/employer/Profile'>
            <div className='sidebar_icon'>
